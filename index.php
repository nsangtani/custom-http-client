...
<head>
    ...
    <title>Custom HTTP Client</title>
...
<body>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="card" style="min-height: 100px; max-height: 300px; overflow-y:auto;">
                                            ...
                                            <div class="card-body">
                                                <img src="./public/images/loading.gif" alt="Not Found" height='100px' width='100px' class="image">
                                                <pre id="code-output">
                                                </pre>
                                            </div>
                                        </div>
    ...
    <script>
        var viewVars = {
            url: window.location.href.replace('index.php', '') + 'makeRequest.php'
        };
